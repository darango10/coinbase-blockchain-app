...
const Dashboard = ({address}) => {
  ...
  useEffect(() => {
    const getSanityAndThirdWebTokens = async () => {
      ...
      const coins = await fetch("https://cecku22p.api.sanity.io/v1/data/query/production?query=*%5B_type%3D%3D%27coins%27%5D%7B%0A%20%20name%2C%0A%20%20usdPrice%2C%0A%20%20contractAddress%2C%0A%20%20symbol%2C%0A%20%20logo%0A%7D");
  ...
  console.log('3rdWeb...', thirdWebTokens);
